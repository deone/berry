...
DATABASES = {
    'default': {
        ...
        'NAME': 'berry',                      # Or path to database file if using sqlite3.
        'USER': 'berry_admin',                      # Not used with sqlite3.
        'PASSWORD': 'b3rry',                  # Not used with sqlite3.
...
SECRET_KEY = 'mz&p7!@q+nys)$0ggwqhiz#f&&3&i)w7f4mxh$efqdq65^7z&o'
